...
Currently, I have checked and found that over 99.82% of possible hex color codes are constructible, and not a single unconstructible color has been found so far. It is very likely that every color is constructible, I just don't know how to prove it.
